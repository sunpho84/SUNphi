...
namespace SUNphi
{
  ...
  public:
    ...
    static constexpr int nDynamic=IsDynamic::hSum; ///< Number of dynamical components
    ...
    static constexpr int maxStaticIdx=IntSeq<(T::size>=0 ? T::size : 1)...>::hMul; ///< Maximal value of the index, restricted to the statical components
  };
}
